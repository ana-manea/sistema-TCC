...
Route::middleware('auth')->group(function () {
    ...
    */
    ...
    | TCCs
    |--------------------------------------------------------------------------
    | Rotas específicas devem ficar antes do Route::resource para evitar que
    | "em-andamento" ou "historico" sejam interpretados como {tcc}.
    |--------------------------------------------------------------------------
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Usuários, orientadores e orientandos
    |--------------------------------------------------------------------------
    */

    Route::resource('users', UserController::class);

    Route::resource('orientandos', OrientandoController::class)
        ->except(['create', 'store']);
    ...
    Route::get('/orientador', function () {
        ...
        return redirect()->route('orientador.dashboard', $orientador);
    });
    ...
    */
    ...
    Route::get('/aluno/feedbacks', [FeedbackController::class, 'indexOrientando'])
        ->name('aluno.feedbacks.index');
});
