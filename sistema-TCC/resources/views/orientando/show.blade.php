...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between gap-4 align-items-center mb-3">
        <div class="d-flex gap-4">
            <a class="btn btn-outline-secondary btn-sm" href="{{ route('orientandos.index') }}">
                <i class="bi bi-arrow-left"></i> Ver todos os orientandos
            </a>
            <h1 class="h3 mb-0 text-gray-800">Detalhes do Orientando</h1>
        </div>
        <div>
